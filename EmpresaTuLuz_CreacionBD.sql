...
cliente_activo			bit CONSTRAINT clientes_activo_nn NOT NULL,
CONSTRAINT clientes_cuit_pk PRIMARY KEY (cliente_cuit))
...
jefe_tipo_doc		INT,
empleado_activo		bit,
CONSTRAINT empleados_pk PRIMARY KEY(empleado_num_doc,empleado_tipo_doc)
)
...
ALTER TABLE empleados
   ...
   FOREIGN KEY (jefe_num_doc,jefe_tipo_doc) REFERENCES empleados (empleado_num_doc,empleado_tipo_doc);

INSERT INTO empleados VALUES(123465,1,'Cristian','Flores','Tandil 1000',1,'351264879',NULL, NULL,0);
INSERT INTO empleados VALUES(156465,2,'Tom','Lopez','Ituzaingo 2000',1,'351123812',123465, 1,0);
INSERT INTO empleados VALUES(1567645,1,'Raul','Jimenez','Velez 230',2,'3516534812',123465, 1,0);
...
empleado_tipo_doc	INT NOT NULL,
usuario_activo		bit,
CONSTRAINT usuarios_pk PRIMARY KEY(usuario_nombre)
)

ALTER TABLE usuarios
   ADD CONSTRAINT usuarios_empleados_fk
   FOREIGN KEY (empleado_num_doc,empleado_tipo_doc) REFERENCES empleados (empleado_num_doc,empleado_tipo_doc);

INSERT INTO usuarios VALUES('admi','admi',123465,1,0);
INSERT INTO usuarios VALUES('user','user',156465,2,0);
