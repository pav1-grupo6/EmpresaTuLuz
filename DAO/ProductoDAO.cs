...
namespace EmpresaTuLuz.DAO
{
    class ProductoDAO
    {
        public static DataTable Obtenerproductoxnombre(string nombreProducto)
        {
            ...
            try
            {
                ...
                string consulta = "SELECT * FROM productos WHERE nombre LIKE @nombr";
                //Agregando parameters
                cmd.Parameters.Clear();
                cmd.Parameters.AddWithValue("@nombr", nombreProducto);
